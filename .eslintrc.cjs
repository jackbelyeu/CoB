module.exports = {
  root: true,
  ignorePatterns: ['dist/**/*', 'functions/lib/**/*', 'coverage/**/*'],
  ...
  overrides: [
    ...
    {
      /* TypeScript/JavaScript in functions/src/ */
      files: ['functions/src/**/*.{js,cjs,mjs,jsx,ts,cts,mts,tsx}'],
      parserOptions: { ecmaVersion: 'latest', tsconfigRootDir: `${__dirname}/functions`, project: true },
      rules: {
        'dot-notation': 'off',
        'no-implied-eval': 'off',
        'require-await': 'off',
